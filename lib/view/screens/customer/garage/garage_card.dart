  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Center(
        child: InkWell(
          onTap: (){
            Navigator.pushNamed(context, AppRoutes.garage_details,arguments:widget.garage );
          },
          child: Card(
            elevation: 5,
            shape:
                  ...
                  children: [
                    Stack(
                      children: [
                        Container(
                          height: 70,
                          decoration: widget.garage.imageUrl==''?BoxDecoration(
                              borderRadius: BorderRadius.only(topLeft: Radius.circular(10),topRight: Radius.circular(10)),
                              image: DecorationImage(
                                  fit: BoxFit.cover,
                                  image: NetworkImage(AppConstants.DEFAULT_GARAGE_IMG))
                          ):BoxDecoration(
                              borderRadius: BorderRadius.only(topLeft: Radius.circular(10),topRight: Radius.circular(10)),
                              image: DecorationImage(
                                  fit: BoxFit.cover,
                    ...
                    Padding(
                      ...
                      Text("Please Add Garage Address", style: TextStyle(fontSize: 11, fontWeight: FontWeight.normal)):
                        Text(
                        "${widget.garage.addressDtls!
                        .houseName}, ${widget.garage.addressDtls!.street}, ${widget.garage.addressDtls?.landmark}, ${widget.garage.addressDtls?.cityname}",
