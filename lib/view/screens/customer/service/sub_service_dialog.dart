...
class SubServiceCustomDialogBox extends StatefulWidget {
  ...
  @override
  _SubServiceCustomDialogBoxState createState() =>
      _SubServiceCustomDialogBoxState();
}
              ...
              DataCell(
                Consumer<ServiceProvider>(
                  builder: (context, model, child) =>
                      Text(model.subServiceListByServiceId[index].name),
                ),
              ),
              widget.cost == true
                  ? DataCell(
                      Consumer<ServiceProvider>(
                        builder: (context, model, child) => Text(
                          model.subServiceListByServiceId[index].costing,
                        ),
                      ),
                    )
                  : DataCell(Text('')),
