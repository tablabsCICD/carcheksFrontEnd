...
class ServiceCard extends StatefulWidget {
  ...
  ServiceCard(this.service, {Key? key, this.cost, this.isFromGuarge})
    : super(key: key);
          ...
          onTap: () async {
            if (widget.isFromGuarge == true) {
              ...
              Navigator.of(context).push(
                MaterialPageRoute(
                  builder: (context) =>
                      ViewServices(mainServiceId: widget.service.id),
                ),
              );
            } else {
              if (AppConstants.vehicle.id == 0) {
                const snackBar = SnackBar(content: Text('Select the Vehicle'));
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      Container(
                        height: 90,
                        decoration: widget.service.photosUrl == ""
                            ? BoxDecoration(
                                ...
                                image: DecorationImage(
                                  fit: BoxFit.fill,
                                  image: NetworkImage(
                                    AppConstants.DEFAULT_SERVICE_IMG,
                                  ),
                                ),
                              )
                            : BoxDecoration(
                      ...
                      Padding(
                        ...
                        child: Column(
                          children: [
                            ...
                            Text(
                              widget.service.shortDiscribtion,
                              overflow: TextOverflow.ellipsis,
                              style: TextStyle(
                                fontSize: 12,
