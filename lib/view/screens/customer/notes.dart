              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Text(
                      "Please provide any notes about the issue that may help the technician with your wheel alignment Adjustment.",
                      style: TextStyle(
                        fontSize: 12,
                ...
                onTap: () {
                  if (notesController.text.isNotEmpty) {
                    ...
                    Navigator.pushNamed(
                      context,
                      AppRoutes.date,
                      arguments: {widget.garage, notesController.text},
                    );
                  } else {
                    var snackBar = SnackBar(
                      content: Text(
                        'Please provide some instructions for technician!',
                      ),
                    );
