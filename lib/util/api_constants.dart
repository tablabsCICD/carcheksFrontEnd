...
class ApiConstants{
  ...
  static String BASE_URL =
      "https://api.carcheks.com/carchecks";
  /*static String BASE_URL =
  ...
  static String ALL_VEHICLE = ApiConstants.BASE_URL +"/VehicleType/VehicleType/getAll";
  static String GET_NEAR_BY_GARAGES(userId,lat,long) => ApiConstants.BASE_URL +
      "/api/getnearbyGaragesbyuserId?usertableId=${userId}&latitude=${lat}&longitude=${long}";
  ...
  static String cartGetByUserId(userId) => ApiConstants.BASE_URL +
      "/api/CartCotroller/getByUserId?userId=${userId}";
  static String saveCart = ApiConstants.BASE_URL + "/api/CartCotroller/save";
  static String removeCart(cartId) => ApiConstants.BASE_URL + '/api/CartCotroller/deleteById?id=${cartId}';
  static String allVehicleType = ApiConstants.BASE_URL + "/VehicleType/VehicleType/getAll";
  static String allVehicleManufacturer =  ApiConstants.BASE_URL + "/VehicleManufacturer/GarageServices/getAll";
  static String getVehiclesByUserId(userId) => ApiConstants.BASE_URL + "/Vehicle/user/getbyuserid?id=${userId}";
  static String updateVehicle = ApiConstants.BASE_URL + "/Vehicle/Vehicle/update";
  static String deleteVehicle(id) =>  ApiConstants.BASE_URL + "/Vehicle/Vehicle/deleteById?id=${id}";
  ...
  static String Get_Appointment_By_Garage_ID=BASE_URL+"/api/Appointment/getByGarrageId";
  static String Get_Appointment_By_User_ID= BASE_URL+"/api/Appointment/getByUserId2";
  //Transaction
  static String SAVE_Transaction= BASE_URL+"/TrasactionPayment/TrasactionPayment/save";
  static String GET_All_Transactions= BASE_URL+"/TrasactionPayment/TrasactionPayment/getAll";
